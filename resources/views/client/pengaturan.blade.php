...
<div class="row justify-content-center">
    ...
    <!-- Ubah Name Modal -->
    <div class="modal fade" id="ubah-name" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
    ...
    <!-- Ubah Password Modal -->
    <div class="modal fade" id="ubah-password" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
