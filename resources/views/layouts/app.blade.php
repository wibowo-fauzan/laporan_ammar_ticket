...
<body id="page-top">
    ...
    <div class="bg-gradient-primary"
        style="height: 500px; border-bottom-left-radius: 50% 20px; border-bottom-right-radius: 50% 20px;">
    ...
    <footer class="sticky-footer bg-white">
        <div class="container my-auto">
            <div class="copyright text-center my-auto">
              <span> Copyright &copy; 2020 @if (date('Y') != '2020') - {{ date('Y') }} @endif &nbsp; All rights reserved • by Ammar Karim Akbar. </span>
            </div>
        </div>
    </footer>
    @endif</a>
